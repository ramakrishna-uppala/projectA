 ...
 * Edit Department
 */
$id_val = isset($department['id']) ? $department['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($department['name']) ? $department['name'] : set_value('name');
?>

<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="edit_department" onsubmit="return false">
			<?= csrf_field(); ?>
			<input type="hidden" name="id" value="<?= $id_val; ?>">
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit Department</h5>
			...
			<div class="modal-body">
                ...
                <div class="modal-footer">
                	<button type="submit" onclick="updateDepartment()" class="btn btn-success btn-sm"><i class="bi bi-check-square"></i>&nbsp;Update</button>
