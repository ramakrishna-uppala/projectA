...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <form method="post" id="addEducationForm" onsubmit="return false">
           
        <div class="modal-header">
                <h5 class="modal-title fs-5">Add Education</h5>
        ...
        <div class="modal-footer">
                <button type="submit" onclick="saveEducation()" class="btn btn-success btn-sm">Add</button>
